<?php
if($_POST['config'] == 'wordpot.conf') {

	$filename='/opt/wordpot/wordpot.conf';
	chmod ($filename, "0777");
...
if(isset($_POST['builderDataWindow'])) {
	...
	if($_POST['confName'] == 'wordpot.conf') {
		$confName=$_POST['confName'];
	 	$myFile = '/opt/wordpot/wordpot.conf';
		...
		<div id="wrapper">
  	 		<div id="branding">
   				...
   				<ul class="topNav">
					...
					<li><a href="wordpot_config.html" class="topNavAct">WordPot</a></li>
   			...
   			<div id="contant">
					...
					<div class="builderFormMenu">
						...
						<select name="config">
							<option value="wordpot.conf">&nbsp; Wordpot Main Config &nbsp;</option>
