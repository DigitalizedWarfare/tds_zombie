<?php
if($_POST['config'] == 'glastopf.cfg') {

	$filename='/opt/glastopf/glastopf/glastopf.cfg';
	chmod ($filename, "0777");
...
if(isset($_POST['builderDataWindow'])) {
	...
	if($_POST['confName'] == 'glastopf.cfg') {
		$confName=$_POST['confName'];
	 	$myFile = '/opt/glastopf/glastopf/glastopf.cfg';
		...
		<div id="wrapper">
  	 		<div id="branding">
   				...
   				<ul class="topNav">
					...
					<li><a href="glastopf_config.html" class="topNavAct">Glastopf</a></li>
   			...
   			<div id="contant">
					...
					<div class="builderFormMenu">
						...
						<select name="config">
							<option value="glastopf.cfg">&nbsp; Glastopf Main Config &nbsp;</option>
						</select>
						<input name="submit" value="" type="submit" class="builderSubmit"/>
						</form>
					</div>
