<?php
if($_POST['config'] == 'amun.conf') {
	
	$filename='/opt/amun/conf/amun.conf';
	chmod ($filename, "0777");
...
if(isset($_POST['builderDataWindow'])) {
	...
	if($_POST['confName'] == 'amun.conf') {
		$confName=$_POST['confName'];
	 	$myFile = '/opt/amun/conf/amun.conf';
		...
		<div id="wrapper">
  	 		<div id="branding">
   				...
   				<ul class="topNav">
					...
					<li><a href="amun_config.html" class="topNavAct">Amun</a></li>
   			...
   			<div id="contant">
					...
					<div class="builderFormMenu">
						...
						<select name="config">
							<option value="amun.conf">&nbsp; Amun Main Config &nbsp;</option>
